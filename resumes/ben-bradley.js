module.exports = {
	...
	skills: [
		{ name: 'Software Development', detail: 'JavaScript, NodeJS, JQuery, PHP, BASH' },
		{ name: 'Telecommunications', detail: 'Metro Ethernet, Fiber Optics, VoIP, Satellite' },
		{ name: 'Project Management', detail: 'Network Services, IT Infrastructure, Software' },
		{ name: 'Operations Management', detail: 'Logistics, Training, Personnel, Safety' },
		{ name: 'Network Control Center', detail: 'CA Spectrum, CA Infrastructure Manager 2.0' },
		{ name: 'Network Administration', detail: 'OSI Layers 1-4, MPLS, BGP, OSPF, Ethernet' },
		{ name: 'Database Management', detail: 'MongoDB, MySQL, MSSQL, Oracle' },
		{ name: 'Knowledge Management', detail: 'SharePoint, MS Office Suite' }
	],
	experienceDetail: [
		{
			company: 'Integra',
		...
		},
		{
			...
			from: 'August 2008',
			to: 'March 2011',
			title: 'Tier 3 Data Network Technician',
			responsibilities: [
		...
		{
			company: 'US Army, 7th Signal Bde',
			from: 'March 2007',
			to: 'May 2008',
			title: 'Intelligence & Network Ops Officer',
			responsibilities: [
		...
		{
			company: 'US Army, MNF-I Headquarters',
			from: 'August 2005',
			to: 'February 2007',
			title: 'Officer in Charge, Communications Support Office',
			responsibilities: [
